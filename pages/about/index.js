          ...
          >
            <div className='flex flex-1 xl:gap=x-6'>
              ...
              after:bg-white/10 after:absolute after:top-0 after:right-0'>
                ...
                <div className='text-xs uppercase tracking-[1x] leading-[1.4] max-w-
                [100px]'>
                  Year of experience
                </div>
              </div>
              {/* clients */}
              <div className='relative flex-1 after:w-[1px] after:h-full
              after:bg-white/10 after:absolute after after:top-0 after:right-0'>
                <div className='text-2xl xl:text-4xl font-extrabold text-accent mb-2'>
            ...
            {aboutData.map((item, itemIndex) => {
              return (
                <div
                  ...
                  [2px] after:bg-white after:absolute afer:-bottom-1 after:left-0`}
                ...
                >
                  ...
                  <div className='flex gap-x-4'>
                    ...
                    {item.icons?.map((icon,itemIndex) => {
                      return (
                        <div className='text2xl text-white'>{icon}</div>
                      );
                    })}
                  </div>
                </div>
