...
const Home = () => {
  return (
    <div className='bg-primary/60 h-full'>
      ...
      to-black/10'>
        ...
        h-full container mx-auto'>
          ...
          <motion.p 
            ...
            animate='show' 
            exit='hidden'
            className='max-x-sm xl:max-w-xl mx-auto xl:mx-0 mb-10 xl:mb-16'
          >
            I am passionate about data and the story they tell. <br></br>I am even more passionate about technology.
          </motion.p>
          {/* btn */}
      ...
      {/* image */}
      <div className='w-[900px] h-full absolute right-0 top-0'>
        {/* img */}
